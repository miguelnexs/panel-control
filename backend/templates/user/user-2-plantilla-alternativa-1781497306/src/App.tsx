      ...
      case 'hero': {
        ...
        if (data.layout === 'full') {
          return (
            ...
            >
              ...
              <div className={`relative z-10 max-w-4xl mx-auto space-y-6 ${data.bg_type === 'image' ? 'text-white' : 'text-gray-900'}`}>
                {(data.show_badge !== false) && (
                  <EditableText 
                    ...
                    className={`inline-block text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider ${data.bg_type === 'image' ? 'bg-white/20 text-white' : 'bg-custom-primary/10 text-custom-primary'}`} 
                  />
                )}
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-black leading-tight tracking-tight">
                  ...
                  <EditableText 
                    ...
                    field="company_name" 
                    disableDrag={true} 
                    className={data.bg_type === 'image' ? 'text-amber-400' : 'text-custom-primary'}
                  />
                </h1>
                ...
                <EditableText 
                  ...
                  className={`text-lg leading-relaxed max-w-2xl mx-auto block ${data.bg_type === 'image' ? 'text-white/95' : 'text-gray-600'}`} 
                />
        ...
        return (
          ...
          >
            ...
            <div className={`relative z-10 max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-12 ${data.bg_type === 'image' ? 'text-white' : 'text-gray-900'}`}>
              <div className="space-y-6">
                ...
                <EditableText 
                  ...
                  position={data.positions?.description}
                  styles={data.styles?.description}
                  className={`text-lg leading-relaxed max-w-lg block ${data.bg_type === 'image' ? 'text-white/90' : 'text-gray-600'}`} 
                />
                ...
                <div className="grid grid-cols-3 gap-1.5 bg-gray-100 p-1 rounded-xl">
                  {['color', 'gradient', 'image'].map((t) => (
                    <button
                      ...
                      className={`py-1.5 text-[10px] uppercase font-black rounded-lg transition-all ${
                        (sectionData[heroIdForModal]?.bg_type || 'color') === t
                          ? 'bg-white text-custom-primary shadow-sm' 
                          : 'text-gray-500 hover:text-gray-900'
                      }`}
                    >
                      {t === 'color' ? 'Color' : t === 'gradient' ? 'Gradiente' : 'Imagen'}
                    </button>
                  ))}
                </div>
