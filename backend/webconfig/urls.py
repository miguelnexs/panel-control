...
urlpatterns = [
    path('ai/chat/', ai_views.AIChatView.as_view(), name='ai_chat'),
    path('ai/chat/sessions/', ai_views.AIChatSessionView.as_view(), name='ai_chat_sessions'),
    path('ai/chat/<int:session_id>/messages/', ai_views.AIChatView.as_view(), name='ai_chat_messages'),
    path('ai/analyze-product/', ai_views.AIAnalyzeProductView.as_view(), name='ai_analyze_product'),
    ...
    path('visible-categories/bulk-update/', VisibleCategoriesBulkUpdateView.as_view(), name='visible_categories_bulk_update'),
    path('visible-products/', VisibleProductsView.as_view(), name='visible_products'),
    path('visible-products/status/', VisibleProductStatusListView.as_view(), name='visible_product_status'),
    path('visible-products/bulk-update/', VisibleProductsBulkUpdateView.as_view(), name='visible_products_bulk_update'),
