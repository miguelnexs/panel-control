...
import AsentingStoreCreator from "@/components/AsentingStoreCreator";
          ...
          <Tabs defaultValue="templates" className="w-full">
            <div className="flex justify-center mb-8">
                <TabsList className="grid w-full max-w-[400px] grid-cols-2">
                    ...
                    <TabsTrigger value="asenting-ai" className="gap-2"><Sparkles className="w-4 h-4 text-purple-500" /> Asenting AI</TabsTrigger>
                </TabsList>
            </div>
            ...
            <TabsContent value="asenting-ai">
                {isLoggedIn ? (
                    <AsentingStoreCreator />
                ) : (
                    <div className="flex flex-col items-center justify-center py-20 text-center glass-card rounded-2xl p-8 max-w-2xl mx-auto">
                        ...
                        <p className="text-muted-foreground mb-8 max-w-md">
                            La creación de tiendas con Asenting AI es una funcionalidad exclusiva para usuarios registrados. Inicia sesión para acceder a esta potente herramienta.
                        </p>
