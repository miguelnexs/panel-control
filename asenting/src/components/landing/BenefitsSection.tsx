...
const benefits = [
  ...
  },
  {
    ...
    description: "Arquitectura robusta y autenticación segura de grado empresarial para proteger tu negocio.",
    stats: "99.9%",
    statsLabel: "disponibilidad"
  },
  {
    icon: Palette,
    title: "Diseño Moderno",
    description: "Interfaz moderna, intuitiva y sumamente fluida para una experiencia optimizada.",
    stats: "100%",
    statsLabel: "responsivo"
  }
];
