      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          <div className="animate-fade-up inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-8">
            ...
            <span className="text-sm text-muted-foreground">Asenting Dashboard v1.0.44</span>
          </div>
          ...
          {/* CTAs */}
          <div className="animate-fade-up-delay-3 flex flex-col items-center justify-center gap-6">
